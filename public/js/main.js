...
},{"./components/List.jsx":180,"react":158,"react-dom":2}],180:[function(require,module,exports){
"use strict";
...
var List = React.createClass({
    ...
    render: function render() {
        var listItems = this.state.ingredients.map(function (ingredient) {
            //At this point we are passing the ingredient text to our ListItem component.
            return React.createElement(ListItem, { key: ingredient.id, ingredient: ingredient.text });
        });
        return React.createElement(
            "div",
            null,
            React.createElement("input", { type: "text", placeholder: "add item", value: this.state.newText, onChange: this.handleInputChange }),
            React.createElement(
                "button",
...
},{"../reflux/actions.jsx":182,"../reflux/ingredientsStore.jsx":183,"./ListItem.jsx":181,"react":158,"reflux":175}],181:[function(require,module,exports){
"use strict";
...
var IngredientsStore = Reflux.createStore({
    ...
    postIngredient: function postIngredient(text) {
        var _this2 = this;
...
var service = {
    ...
    post: function post(url, ingredient) {
